...
<section class="forms-basic" ng-controller="ProjectController">
	...
	<div class="row m-b-40">
		<div class="col-sm-3">
			<div class="card bordered small">
		          ...
		          <div class="card-title"><i class="md md-location-on"></i> 区域检索</div>
		        </div>
		...
		<div class="col-sm-9">
			<div class="table-responsive well no-padding white no-margin">
		        ...
		        <div class="pull-right" ng-if="currentNode">
		          <a type="button" class="btn black-text f12" style="margin: 18px 24px 0 0;" ng-click="create(currentNode)">
		          	<i class="md md-add" style="color: #33cc99">在 <span style="color:red"><i>{{currentNode.areaName}}</i></span> 新增项目 </i>
		          </a>
	            </div>
				...
				<table class="table table-hover table-full m-b-60" id="table-project-2172158">
					<thead>
						<tr fsm-sticky-header scroll-body="'#table-project-2172158'" scroll-stop="64">
							<th></th>
							<th>项目名称</th>
							<th>项目编码</th>
							<th>业主名称</th>
					...
					<tbody>
						<tr ng-repeat="(key, project) in data" ng-if="(currentNode && project.projectAreaId==currentNode.projectAreaId) || !currentNode" ng-hide="keyword!='' && (project.projectName.indexOf(keyword)<0 && project.projectCode.indexOf(keyword)<0 && project.ownerName.indexOf(keyword)<0 && project.ownerPhoneNo.indexOf(keyword)<0)">
							<td class="f20 ng-binding"><i class="md md-local-play light-green lighten-1 icon-color"></i></td>
							...
							<td class="text-center" ng-click="$event.stopPropagation()">
								...
								<button type="button" class="btn btn-link btn-round"
									data-title="详情" ng-click="detail(project)"
									data-placement="bottom" bs-tooltip>
	...
	<div class="footer-buttons">
		<div class="btn btn-primary btn-round " ng-click="create(currentNode)" ng-if="currentNode" data-title="在  {{currentNode.areaName}} 下新增项目" bs-tooltip>
			<i class="md md-add"></i>
		</div>
