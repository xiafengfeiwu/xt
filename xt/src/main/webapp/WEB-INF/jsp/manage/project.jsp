		...
		<div class="col-sm-3">
			<div class="card bordered small">
				...
				<div class="card-content">
					<div treecontrol class="tree-boot" tree-model="projectAreas" options="treeOptions" selected-node="currentNode">{{node.areaName}}</div>
				</div>
			</div>
		</div>
		<div class="col-sm-9">
						...
						<table class="table table-hover table-full m-b-60"
							...
							<tbody>
								<tr ng-repeat="(key, project) in data"
									...
									<td class="text-center">{{ project.ownerName }}</td>
									<td class="text-center">{{ project.heatingArea }} ㎡</td>
									<td class="text-center">{{ project.heatingTemp }} ℃</td>
