      ...
      <form class="form-floating" novalidate="novalidate" ng-submit="save()">
        <fieldset>
          ...
          <div class="form-group filled">
            ...
            <input type="text" class="form-control" ng-model="project.projectAreaId" required minlength=2 maxlength=20 />
          </div>
          <div class="form-group filled">
            <label class="control-label">项目业主</label>
            <ui-select ng-model="users.selected" theme="select2" search-enabled="true" required>
              <ui-select-match placeholder="选择一个业主"><span ng-bind="$select.selected.userName"></span></ui-select-match>
          ...
          <div class="form-group filled">
            ...
            <ui-select ng-model="types.selected" theme="select2" search-enabled="false" required>
