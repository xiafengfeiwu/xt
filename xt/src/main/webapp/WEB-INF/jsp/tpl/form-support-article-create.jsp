      ...
      <div class="modal-body">
		<form class="form-floating" novalidate="novalidate">
          <div class="form-group filled">
            ...
            <input type="text" data-ng-model="knowledge.knowledgeTitle" class="form-control"/>
          </div>
          <div class="form-group filled">
            <label>内容</label>
            <textarea style="width:100%" id="articleContent"></textarea>
          </div>
	    </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-ng-click="saveKnowledge()">提交</button>
