...
<div class="aside bs-docs-aside" tabindex="-1" role="dialog">
  ...
  <div class="aside-dialog">
    <div class="aside-body bs-sidebar">
      <form class="form-floating placeholder-form" novalidate="novalidate" ng-submit="save()">
        <fieldset>
          <legend>新增产品 </legend>
          <div class="form-group">
            <div class="radio-inline">
              <label>
                <input type="radio" name="productType" checked="checked" ng-click="changeType('R')"> 热泵产品
              </label>
            </div>
            <div class="radio-inline">
              <label>
