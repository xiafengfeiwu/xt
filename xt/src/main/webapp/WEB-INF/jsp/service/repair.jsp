...
<section class="forms-basic" ng-controller="RepairController">
	...
	<div class="row m-b-40">
		<div class="col-sm-12">
			<form name="form">
				<div class="btn" data-ngf-select data-ng-model="file"
					data-name="file" data-ngf-max-size="2MB"
					data-ngf-accept="'image/gif,image/jpeg,image/jpg,image/png'">选择单文件</div>
				<button type="submit" data-ng-show="form.file.$valid" data-ng-click="uploadImg()">submit</button>
			</form>
			<div class="table-responsive well no-padding white no-margin">

				<table class="table table-hover table-full m-b-60"
					id="table-repair-2172158">
					<thead>
						...
						<tr>
							...
							<td class="text-center" ng-click="$event.stopPropagation()">
								<button type="button" class="btn btn-link btn-round"
									data-title="详情" data-placement="bottom" bs-tooltip>
