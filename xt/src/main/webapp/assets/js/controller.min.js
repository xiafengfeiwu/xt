...
app.controller("PumpController", ["$rootScope", "$scope", "$aside", "$http", "$location", "$timeout","layerService", function(rootScope, scope, aside, http, location, timeout, layerService) {
...
app.controller("SupportController", ["$scope", "$http", "$aside", "layerService", function(scope, http, aside, layerService) {
...
app.controller("RepairController", ["$scope", "$http", "$aside", "layerService", function(scope, http, aside, layerService) {
