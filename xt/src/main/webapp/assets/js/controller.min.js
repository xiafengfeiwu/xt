...
app.controller("DashboardController", function($rootScope, $scope, $aside, $location, localStorageService) {
...
app.controller("PumpController", function($rootScope, $scope, $location, localStorageService, $http) {
...
app.controller("ConsoleController", function($rootScope, $scope, $window, $http, localStorageService) {
	$rootScope.pageTitle = "热泵名称";
	
	$scope.pumpId = localStorageService.get("pumpId");
...
app.controller("ProjectController", ["$scope", "$aside", "$http", "layerService", function(scope, aside, http, layerService) {
    ...
    detailForm = aside({
        scope: scope,
        template: "tpl/form-project-detail.jspx",
        show: !1,
        placement: "left",
        backdrop: !1,
        animation: "am-slide-left"
...
app.controller("ProjectAreaController", function($rootScope, $scope, $http, $aside, layerService) {
