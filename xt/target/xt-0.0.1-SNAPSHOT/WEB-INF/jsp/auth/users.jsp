...
<div ng-controller="UserController">
	<div class="table-responsive well no-padding white no-margin">
		...
		<table class="table table-full m-b-60" id="table-user-2172158" >
			<thead>
			...
			<tbody>
				<tr ng-repeat="(key, user) in data" ng-dblclick="edit(user)" ng-if="keyword=='' || (user.userLoginName.indexOf(keyword)>=0 || user.userName.indexOf(keyword)>=0 || user.userNamePy.indexOf(keyword)>=0 || user.userPhone.indexOf(keyword)>=0)">
					...
					<td title="双击编辑当前记录"> {{ user.userName }}</td>
